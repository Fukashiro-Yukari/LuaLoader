...
namespace LuaLoader.Helpers
{
    public static class Texture2DHelpers
    {
        ...
        private static MethodInfo GetEncodeToPNGMethod()
        {
            ...
            MelonLoader.MelonLogger.Log("ERROR: Cannot get any EncodeToPNG method!");
            return null;
        }
#endif
        ...
        public static Texture2D ForceReadTexture(Texture2D tex)
        {
            ...
            {
                MelonLoader.MelonLogger.Log("Exception on ForceReadTexture: " + e.ToString());
                return default;
            }
        }
        ...
        public static void SaveTextureAsPNG(Texture2D tex, string dir, string name, bool isDTXnmNormal = false)
        {
            ...
            {
                MelonLoader.MelonLogger.LogWarning("Couldn't get any data for the texture!");
            }
            else
            {
